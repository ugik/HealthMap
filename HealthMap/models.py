...
class Dataset(models.Model):
    ...
    maplatitude = models.CharField(max_length=15, blank=True)
    maplongitude = models.CharField(max_length=15, blank=True)
    mapzoom = models.CharField(max_length=2, blank=True)
